...
public class ModuloController {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "404", description = "No se encuentra el recurso que intentabas alcanzar", content = @Content()) })
	@GetMapping("/{id}")
	public ResponseEntity<Modulo> listarPorId(@PathVariable("id") Integer id) throws Exception {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "404", description = "No se encuentra el recurso que intentabas alcanzar", content = @Content()) })
	@GetMapping("/k/{key}")
	public ResponseEntity<Modulo> listarPorKey(@PathVariable("key") String key) throws Exception {
	...
	@PostMapping
	public ResponseEntity<Modulo> registrar(@Valid @RequestBody Modulo data) throws Exception {
		Modulo obj = service.registrar(data);
		return new ResponseEntity<Modulo>(obj, HttpStatus.CREATED);
	}
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "404", description = "Recurso no encontrado", content = @Content()) })
	@PutMapping
	public ResponseEntity<Modulo> modificar(@Valid @RequestBody Modulo data) throws Exception {
